...
// provider error strings. They may return only application sentinels or a
// validated ProviderFailureError. The provider must scope every call to the
// supplied actor, account, and observed lifecycle version.
